var reveni = (function () {
  ...
  var close = function close(elementSelector, redirectUrl, returnStatus, onSuccess, onReject, onFinish) {
  ...
  var init = function init(orderId, returnId, elementSelector, token, sandbox) {
    ...
    var onFinish = arguments.length > 8 ? arguments[8] : undefined;
  ...
  window.reveni = {
    init: function init(orderId, returnId, token, elementSelector) {
      ...
      var onFinish = arguments.length > 7 ? arguments[7] : undefined;
      return reveni.init(orderId, returnId, elementSelector, token, sandbox, true, onSuccess, onReject, onFinish);
    },
  ...
  var index = {
    init: function init(orderId, returnId, token, elementSelector) {
      ...
      var onReject = arguments.length > 6 ? arguments[6] : undefined;
      var onFinish = arguments.length > 7 ? arguments[7] : undefined;
      return reveni.init(orderId, returnId, elementSelector, token, sandbox, false, onSuccess, onReject, onFinish);
    },
    close: function close(elementSelector) {
      return reveni.close(elementSelector);
    }
