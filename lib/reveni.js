...
const close = (elementSelector, redirectUrl, returnStatus, callbacks) => {
  ...
  if (returnStatus === 'dismiss' && callbacks !== null && callbacks !== void 0 && callbacks.onDismiss) callbacks.onDismiss();
  if (returnStatus === 'success' && callbacks !== null && callbacks !== void 0 && callbacks.onSuccess) callbacks.onSuccess();
  if (returnStatus === 'rejected' && callbacks !== null && callbacks !== void 0 && callbacks.onReject) callbacks === null || callbacks === void 0 ? void 0 : callbacks.onReject();
  if (redirectUrl && !(callbacks !== null && callbacks !== void 0 && callbacks.onSuccess) && !(callbacks !== null && callbacks !== void 0 && callbacks.onReject) && !(callbacks !== null && callbacks !== void 0 && callbacks.onFinish)) window.location = redirectUrl;
};
