...
test('Should execute close function and execute onSuccess callback', async () => {
  ...
  _reveni.default.init(undefined, undefined, undefined, undefined, undefined, undefined, successFn);
...
test('Should execute close function and execute onReject callback', async () => {
  ...
  _reveni.default.init(undefined, undefined, undefined, undefined, undefined, undefined, undefined, onReject);
